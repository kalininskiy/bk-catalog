...
| **Синтаксис**          | PDP-11 / Turbo8 + расширения BKTurbo8 (.script, .ends, @include, %0=)     | Классический PDP-11 + расширения PDPy11 (.repeat, .extern, .dword, .charset)             | Классический DEC MACRO-11                                                              |
