...
- ✅ Эмуляция процессора К1801ВМ1 и системного таймера
- ✅ Поддержка БК-0010-01 и БК-0011М
- ✅ Поддержка эффектов мультиколора
- ✅ Поддержка расширения памяти 512Кб - ДОЗУ Контроллер СМК-512
- ✅ Звук: Speaker, Covox, AY-3-8910, 2xAY TurboSound
- ✅ Дисковод (FDD) - КНГМД, Контроллер СМК-512
- ✅ Жесткий Диск (IDE) - Контроллер СМК-512
- ✅ Отладчик с дизассемблером
- ✅ Загрузка файлов: BIN, COD, BKD, IMG, HDS, HDI, ROM, ZIP
- ✅ Загрузка "многофайловых" кассетных игр и программ, с автоматической дозагрузкой
...
| .IMG   | Образы дискет           |
| .HDS   | Образы жестких дисков   |
| .HDI   | Образы жестких дисков   |
| .ROM   | ROM-файлы               |
