...
BKkeys = function()
{
  ...
  /**
   * Флаг клавиши «СУ» (аналог Ctrl на КОИ-2).
   * Генерирует управляющие коды 1–31 (код & 0x1F)
  ...
  /**
   * Размер viewBox SVG-клавиатуры Bk0011m_kbd_compact.svg
   * Используется для перевода клика и вспышки в координаты клавиш
   */
  this.vkbViewBox = {
    w: 290583.53,
    h: 112675.55
  ...
  /**
   * Инициализация раскладки виртуальной клавиатуры
   * Прямоугольники клавиш — абсолютные координаты из SVG (viewBox)
   */
  function vkbinit() {
    
    // ---- POSITION DATA (SVG viewBox) ----
    // Пары [x, y, width, height]
    var P = [
      // Верхний ряд: ПОВТ…СТОП
      1062, 620, 26000, 17000,
      29163, 620, 26000, 17000,
      57271, 620, 26000, 17000,
      85376, 620, 26000, 17000,
      113480, 620, 26000, 17000,
      141585, 620, 26000, 17000,
      169689, 620, 26000, 17000,
      197794, 620, 26000, 17000,
      225398, 620, 31780, 17000,
      258272, 620, 31780, 17000,
      // Цифровой ряд
      1062, 19370, 17000, 17000,
      19312, 19370, 17000, 17000,
      38062, 19370, 17000, 17000,
      56812, 19370, 17000, 17000,
      75562, 19370, 17000, 17000,
      94312, 19370, 17000, 17000,
      113062, 19370, 17000, 17000,
      131812, 19370, 17000, 17000,
      150562, 19370, 17000, 17000,
      169312, 19370, 17000, 17000,
      188062, 19370, 17000, 17000,
      206812, 19370, 17000, 17000,
      225562, 19370, 17000, 17000,
      245062, 19370, 17000, 17000,
      262672, 19370, 31780, 17000,
      // Второй ряд
      1562, 38120, 25000, 17000,
      28512, 38120, 17000, 17000,
      47262, 38120, 17000, 17000,
      66012, 38120, 17000, 17000,
      84762, 38120, 17000, 17000,
      103512, 38120, 17000, 17000,
      122262, 38120, 17000, 17000,
      141012, 38120, 17000, 17000,
      159762, 38120, 17000, 17000,
      178512, 38120, 17000, 17000,
      197262, 38120, 17000, 17000,
      216012, 38120, 17000, 17000,
      234762, 38120, 17000, 17000,
      254036, 38120, 17000, 17000,
      273036, 38120, 17000, 17000,
      // Третий ряд
      553, 56870, 31780, 17000,
      33287, 56870, 17000, 17000,
      52037, 56870, 17000, 17000,
      70787, 56870, 17000, 17000,
      89537, 56870, 17000, 17000,
      108287, 56870, 17000, 17000,
      127036, 56870, 17000, 17000,
      145786, 56870, 17000, 17000,
      164537, 56870, 17000, 17000,
      183286, 56870, 17000, 17000,
      202037, 56870, 17000, 17000,
      220787, 56870, 17000, 17000,
      240012, 56870, 17000, 17000,
      257862, 56870, 29000, 17000,
      // Четвёртый ряд
      560, 75620, 22600, 17000,
      24112, 75620, 17000, 17000,
      42862, 75620, 17000, 17000,
      61611, 75620, 17000, 17000,
      80362, 75620, 17000, 17000,
      99111, 75620, 17000, 17000,
      117861, 75620, 17000, 17000,
      136611, 75620, 17000, 17000,
      155362, 75620, 17000, 17000,
      174112, 75620, 17000, 17000,
      192862, 75620, 17000, 17000,
      212462, 75620, 20000, 17000,
      // Пятый ряд + стрелки
      564, 94370, 36500, 17000,
      38012, 94370, 22600, 17000,
      61562, 94370, 134800, 17000,
      197313, 94370, 36500, 17000,
      254067, 75620, 17000, 17000,
      235667, 84370, 17000, 17000,
      253512, 94370, 17000, 17000,
      273167, 84370, 17000, 17000
    ];
    ...
    // Стрелки (70–73) в порядке SVG: ↑ ← ↓ →
    var H = [9,24,25,39,53,68,70,71,72,73];
    
    // h: Corresponding HTML keycodes / BK-oriented codes for special keys
    // 39=ВС→обрабатывается отдельно; стрелки: Up,Left,Down,Right
    var h = [27,8,9,8,13,32,38,37,40,39];
    ...
    // Абсолютные прямоугольники из SVG viewBox
    for (i = 0; i < P.length; ) {
      x = P[i++];
      y = P[i++];
      w = P[i++];
      ...
      a.push({
        ...
        X0: x,            // Left edge (viewBox)
        Y0: y,            // Top edge (viewBox)
        X2: x + w,        // Right edge (viewBox)
        Y2: y + hgt       // Bottom edge (viewBox)
      });
    }
  ...
  this.kbpressed = function(U) {
    ...
    // Reset SU (Control) flag — it is one-shot (active for one keypress)
    var suWasActive = SU;
    SU = false;
    ...
    // ---- PROCESS KEY PRESS ----
    if (o != null) {
      // Границы клавиши в viewBox — для вспышки; центр — для совместимости
      U.X0 = o.X0;
      U.Y0 = o.Y0;
      U.X2 = o.X2;
      U.Y2 = o.Y2;
      ...
      // ---- SPECIAL SYSTEM KEYS ----
      if (o.i == 9) {                            // NMI button (interrupt) / СТОП
        cpu.nmi();
        return 1;
      }
